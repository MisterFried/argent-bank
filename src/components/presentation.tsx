	...
	return (
		<section className="grid grid-rows-3 grid-cols-1 md:grid-rows-1 md:grid-cols-3 gap-12 p-12">
			<article className="flex flex-col items-center gap-4">
				<img className="w-[150px] h-[150px] border-8 rounded-full border-primary" src="/public/images/icon-chat.png" alt="Icone chat" />
			...
			<article className="flex flex-col items-center gap-4">
				<img className="w-[150px] h-[150px] border-8 rounded-full border-primary" src="/public/images/icon-money.png" alt="Icone money" />
			...
			<article className="flex flex-col items-center gap-4">
				<img className="w-[150px] h-[150px] border-8 rounded-full border-primary" src="/public/images/icon-security.png" alt="Icone security" />
